...
historyData.forEach((history) => {
    ...
    const headerInnerTemplate = `
        <div class="header-inner inner-padding">
            <div class="header inner-border flex column j-c">
                <h1><span>Season</span> <br>${history.year}</h1>
            </div>
        </div>

        <div class="header-inner inner-padding">
            <div class="team-info inner-border flex c-c">
    ...
    const $teamintroInner = newElement('div', 'team-introduce-inner inner-border');
    ...
    <div class="season-img-container inner-padding">
        <div class="season-img inner-border flex column j-b">
    ...
    <div class="video-inner-container inner-padding">
        <div class="video inner-border flex c-c">
            <video src=${history.scene[0].src.VideoPath}></video>
        </div>
    </div>`
    ...
    <div class="button-container flex">
        <div class="button-inner inner-padding">
            <div class="button inner-border flex">
                <div class="info flex a-c">
...
`
    $videoMain.insertAdjacentHTML('beforeend', $btnContainer);

    const $matchInfoContainer = newElement('div', 'match-info-container inner-padding');
    $videoMain.appendChild($matchInfoContainer);

    const $matchInfoInner = newElement('div', 'match-info-inner inner-border flex column j-b');
    $matchInfoContainer.appendChild($matchInfoInner);
    $matchInfoInner.insertAdjacentHTML(
        'beforeend',
        `<div class="background inner-border" style="background-image:url('${history.scene[0].src.imgPath}')"></div> ${containerHeaderTemplate('Match', 'info')}`
    );
    ...
    const $seasonInfo = newElement('div', 'season-info inner-border flex column j-b');
    ...
    const $seasonchamp = newElement('div', 'season-champ inner-border');
